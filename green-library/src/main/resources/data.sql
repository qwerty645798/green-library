...
INSERT INTO books (book_id, author_id, publisher_id, genre_id, genre_fullname, title,
img, isbn, location, availability, summary, publication_date, borrow_count)
VALUES (book_idx.NEXTVAL, 1, 1, '800', '813.9가', '버터버터11호', 'ex10.png', '456123790', '2층 3번째 책장', '0', '요약이 조아요', TO_DATE('2022-02-02', 'YYYY-MM-DD'), 1);
...
INSERT INTO inquiries(inquiry_id, inquiry_date ,inquiry_title, contents, responserTF, user_id)
VALUES(inquiry_idx.NEXTVAL, sysdate, '문의 처음으로 드립니다', '사이트좀 제대로 만들어주라', 1, 'id1');
INSERT INTO inquiries(inquiry_id, inquiry_date, inquiry_title, contents, responserTF, user_id)
VALUES(inquiry_idx.NEXTVAL, sysdate, '문의 처음으로 드립니다', '사이트좀 제대로 만들어주라', 0, 'id1');
