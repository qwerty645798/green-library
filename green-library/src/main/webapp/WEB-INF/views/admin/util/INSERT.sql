...
INSERT INTO admin_grants(grant_rank, grant_name) VALUES(2, '게시판 작성');
INSERT INTO admin_grants(grant_rank, grant_name) VALUES(1, '관리');

-- 관리자
INSERT INTO admins (admin_id, admin_name, admin_pass, grant_rank) VALUES('admin0', '이름들' 'admin0', 1);
INSERT INTO admins (admin_id, admin_name, admin_pass, grant_rank) VALUES('admin1', '이름들' 'admin1', 2);
INSERT INTO admins (admin_id, admin_name, admin_pass, grant_rank) VALUES('system', '이름들' 'system', 3);


-- 이후는 JDBC query 작성 참고용으로 작성된 것들 입니다.

INSERT INTO announcements(announcement_id, announce_title, writer_id, write_date, file, contents, view_count)
VALUES(announce_idx.NEXTVAL, '첫 공지사항', 'admin1', SYSDATE, 'asdf.hwp', '첫 공지사항 example 작성해봅니다', 0);

INSERT INTO inquiries(inquiry_id, inquiry_title, file, contents, user_id)
VALUES(inquiry_idx.NEXTVAL, '문의 처음으로 드립니다', 'asdf.hwp', '사이트좀 제대로 만들어주라', 'id1');
